...
public class Parade {
    ...
    public ArrayList<Card> removeEligibleCards(Card playedCard) {
        ...
        ArrayList<Card> paradeCardsCopy = new ArrayList<>(paradeCards);
        for (Card currentParadeCard:paradeCardsCopy) {
    ...
    //compile command: javac -d out app/resource/parade.java
